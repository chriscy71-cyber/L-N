...
<div class="app-brand-bar">
    <span>⚓ Σταθμοί Λάρνακας version 5.0 (Supabase Sync Active)</span>
...
def admin():
    ...
    """, users=users, msg=msg, roster_active=is_roster_active(), super_admin_id=super_admin_id, is_super_admin=is_super_admin)
