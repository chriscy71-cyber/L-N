...
# =====================================================================
# 3. ΔΙΑΧΕΙΡΙΣΗ ΑΡΧΕΙΩΝ, ΣΥΓΧΡΟΝΙΣΜΟΣ & FEDERATION WEBHOOKS
# =====================================================================
...
<div style="max-width:1100px; margin:0 auto 10px; display:flex; justify-content:space-between; color:#e2e8f0; font-weight:bold;">
    <span>⚓ Σταθμοί Λάρνακας version 7.1 (Guaranteed DB Recovery)</span>
...
def admin():
    ...
    return render_template_string(BASE_STYLE + """
    <div class="container"><h2>🛠️ Πάνελ Διαχείρισης (v7.1)</h2><a href="/" class="btn-link btn-home">⮜⮜ Επιστροφή στην Αρχική</a>
        <p style="color:red; font-weight:bold;">{{ msg }}</p>
